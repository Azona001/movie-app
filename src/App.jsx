...
const App = () => {
    ...
    const fetchMovies = async (query = '') => {
        ...
        try{
            const endpoint = query ?
                `${API_URL}/search/movie?query=${encodeURIComponent(query)}&sort_by=popularity.desc`
    ...
    <main>
        ...
        <div className='wrapper'>
            ...
            <h4 className='text-white text-center py-2 mt-4'>{searchTerm ? `Searched for: ${searchTerm.toUpperCase()}`: '' }</h4>
        </div>
    </main>
